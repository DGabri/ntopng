local lang = {
  ...
  ["about"] = {
    ...
    ["handle_licenses"] = {
      ...
      ["page_notes_credentials"] = "表の上（右上隅）の <button class='btn btn-link mb-1 p-0'><i class='fas fa-cog me-1'></i>認証情報</button> をクリックして、以前に設定した認証情報（メールと認証トークン）を変更します。これらの情報は、ntop サーバーからライセンス/注文を取得するために使用されます。",
      ["page_notes_last_update"] = "表の上（左上隅）の<span class='text-muted'>最終更新</span>には、ntopサーバーから情報が最後に取得された時間が表示されます。 <button class='btn btn-link mb-1 p-0'><i class='fas fa-cloud-arrow-down me-1'></i>更新</button> をクリックして更新します。",
  ...
  ["license_page"] = {
    ...
    ["note_info_about_the_license"] = "ライセンスに関する一般的な情報は、<a href='https://www.ntop.org/?faq-group=products-and-licenses'>こちら</a>でご覧いただけます。",
